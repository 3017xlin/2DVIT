...
class ViTProcessor(nn.Module):
    def __init__(self, grid_size=64, patch_size=2, dim=256, num_layers=5, num_heads=8, ffn_hidden=1024):
        super().__init__()
        ...
        self.layers = nn.ModuleList([
            TransformerBlock(dim=dim, num_heads=num_heads, ffn_hidden=ffn_hidden)
