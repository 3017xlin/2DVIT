...
for i in range(args.nmodel):
    if args.model == 'UrbanWindViT':
        ...
        # Cache is the source of truth for grid params (size + range). This
        # prevents a silent geometry mismatch if preprocess.py was run with
        # different --grid_size / --grid_*_range than the model defaults.
